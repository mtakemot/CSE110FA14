       ...
       /* String first= "";
        ...
        {   
            ...
            if (action.equals("1"))
            {
                ...
                System.out.print("\n\n             TEST                    \n\n");
                UserAccount newUser = MasterTable.insertUserAccount(action2);
                System.out.print("\n\n             TEST 1                   \n\n");
                while (newUser == null)
                {/*
                   ...
                   // action2= null;
                    ...
                    if(action1.equals("1"))
                    {
                            ...
                            newUser = MasterTable.insertUserAccount(action3);
                    }
            ...
            else if (action.equals("2"))// this will prevent other entries besides "1" and "2"
            {
                ...
                System.out.print("\nUsername: ");
                action2=input.nextLine();
                UserAccount currUser = MasterTable.findUserAccount(action2);
                ...
                while (currUser == null)
                {
                    ...
                    if(action1.equals("1"))
                    {
                        ...
                        System.out.print("\nPlease enter a different username: ");
                        action2 = input.nextLine();
                        currUser = MasterTable.findUserAccount(action2);
                    }
                    //exit to menu
                    else 
                    {   
