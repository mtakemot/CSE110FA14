...
public class UserAccountWrapper
{
     ...
     * and it's related bank accounts by delegating to the getAccountInfo
     * getter method defined below.
     * @param curr
     */
     ...
     * @param rowIndex int representing the index of the bank account
     *          that will have the balance replaced. 
     */
