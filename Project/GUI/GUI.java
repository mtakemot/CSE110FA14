...
File Name:      GUI.java
Description:    This will be the main controller class for our entire GUI. 
                Panels/buttons/textboxes etc that we want in our GUI can be 
                declared outside of this class then we can create objects of those
                classes inside of this class to show those elements. The key is,
                we MUST pass MainPanel in to the constructor of everything 
                that we create outside of this class. This class will
                declare a MainPanel which will have a CardLayout. This MainPanel
                will hold all of our other panels, and we will be able to show
                and hide them at will. Our HashTable will also be       
                accessible to all of our UI regardless of where they are defined
